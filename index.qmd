...
key-points:
  - El estudio evaluó si las características morfológicas (longitud y profundidad del pico, longitud de la aleta y masa corporal) pueden predecir el sexo de tres especies de pingüinos Pygoscelis en el Archipiélago Palmer, encontrando que la profundidad del pico fue el mejor predictor.
  - El modelo de regresión logística tuvo un mejor desempeño que el de bosque aleatorio, con una exactitud de 0.857 y un área bajo la curva ROC de 0.938, lo que permite inferir el sexo de manera confiable mediante datos morfológicos.
date: last-modified
...
El trabajo de campo fue realizado en el Archipiélago Palmer, al oeste de la Peninsula Antártica, cerca de la Isla Anvers (64°46′S, 64°03′W), durante los veranos australes de 2007/08, 2008/09 y 2009/10 [@wilson2018]. Las muestras fueron recolectadas en tres islas específicas (@fig-mapa-distribucion):
